  ...
  return (
    <section id="products" className="min-h-screen bg-transparent py-16">
      <Helmet>
        ...
        <meta
          name="description"
          content="Browse our epic collection of gaming accessories including headsets, controllers, and more for the ultimate gaming experience!"
        />
        <meta
          name="keywords"
          content="gaming accessories, gaming store, buy gaming gear, headsets, controllers, online game store, game collection"
        />
        <meta name="author" content="Bsquare" />
      </Helmet>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="header font-extrabold text-white text-center mb-12 drop-shadow-lg">
            ...
            finalProducts.map((product) => (
              ...
              >
                ...
                <div className="p-6 relative">
                  <h4 className="text-2xl text font-bold text-gray-900 mb-3 leading-tight">
                    {product.name}
                  </h4>
                  <p className="text-gray-700 text text-sm mb-4 line-clamp-2 opacity-90">
                    {product.description}
                  </p>
